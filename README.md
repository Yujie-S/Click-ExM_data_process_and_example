...
4. Select a small region to calculate RMS error when prompted (Use your mouse to draw a square on the figure, double click the selected region when finished).
...
##### There will be five `.svg` files and four `.xlsx` files in the newly created `processed_data` folder:
